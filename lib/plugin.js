  ...
  compiler.plugin('compilation', function (compilation) {
    ...
    compilation.plugin('optimize-chunk-assets', function (chunks, callback) {
      ...
      if (typeof langAsset === 'undefined') {
        ...
        if (Object.keys(assets).length > 1) {
          _this.mainBundleName = Object.keys(assets)[Object.keys(assets).length - 1];
            ...
            (function () {
              ...
              if (_value) {
                (function () {
                  ...
                  var filename = file.replace(/\[(?:(\w+):)?contenthash(?::([a-z]+\d*))?(?::(\d+))?\]/ig, function () {
                  ...
                  if (file !== filename) {
                    _this.assetsToRemove.push(file);
                  }
                })();
              }
            })();
    ...
    compilation.plugin('optimize-assets', function (assets, callback) {
      ...
      Object.keys(assets).forEach(function (asset) {
        if (_this.assetsToRemove.indexOf(asset) !== -1) {
